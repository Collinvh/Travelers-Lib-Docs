...
**See [**attributes**](_attributes) for a more indepth guide for attributes.**
...
**See [**items**](_items) for a more indepth guide for item interfaces.**
...
**See [**animator**](__animator) for a more indepth guide for animators.**
...
**See [**task providers**](__tasks) for a more indepth guide for task providers.**
